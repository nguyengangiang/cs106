...
public class BouncingBall extends GraphicsProgram {
	...
	/** Animation delay of pause time between ball moves */
	...
	private void moveBall() {
		// Increase velocity due to gravity on each cycle
		yVel += GRAVITY;
		ball.move(xVel, yVel);
	}
	
	/** Determine if collision with floor, update
	 * velocities and location as appropriate
	 */
	private void checkForCollision() {
		...
		if(ball.getY() > (getHeight() - DIAM_BALL)) {
			...
			// floor equal to the amount it would have
